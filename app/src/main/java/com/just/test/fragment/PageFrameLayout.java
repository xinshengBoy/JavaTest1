...
import com.just.test.activity.AppWelComePage;
import com.just.test.adapter.PageFragmentAdapter;
import com.just.test.custom.PageFragment;
...
public class PageFrameLayout extends FrameLayout implements ViewPager.OnPageChangeListener {
    ...
    public void setUpViews(int layoutIds[], int dot_on, int dot_off) {
        ...
        setSelectVp(0);
        AppWelComePage activity = (AppWelComePage) getContext();
