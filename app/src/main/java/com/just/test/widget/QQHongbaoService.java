...
public class QQHongbaoService extends AccessibilityService {
	...
	@SuppressLint("NewApi") public void recycle(AccessibilityNodeInfo info) {
	...
	@SuppressLint("NewApi") private String getHongbaoText(AccessibilityNodeInfo node) {
	      /* 获取红包上的文本 */
		String content;
		try {
	...
	@SuppressLint("NewApi") private List<AccessibilityNodeInfo> findAccessibilityNodeInfosByTexts(AccessibilityNodeInfo nodeInfo, String[] texts) {
