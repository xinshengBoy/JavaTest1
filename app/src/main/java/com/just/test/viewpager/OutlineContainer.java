...
public class OutlineContainer extends FrameLayout implements Animatable {
	...
	private void init() {
		...
		mOutlinePaint.setStrokeWidth(JazzyViewUtil.dpToPx(getResources(), 2));
		mOutlinePaint.setColor(0xFF33E5B5);
		mOutlinePaint.setStyle(Style.STROKE);

		int padding = JazzyViewUtil.dpToPx(getResources(), 10);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		int offset = JazzyViewUtil.dpToPx(getResources(), 5);
