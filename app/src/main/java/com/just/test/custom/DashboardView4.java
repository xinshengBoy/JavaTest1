...
public class DashboardView4 extends View {
    ...
    private void init() {
        ...
        mColors = new int[]{ContextCompat.getColor(getContext(), R.color.color_greens),
                ContextCompat.getColor(getContext(), R.color.color_yellows),
                ContextCompat.getColor(getContext(), R.color.color_reds)};
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawColor(ContextCompat.getColor(getContext(), R.color.color_darks));
        /**
         * 画圆弧
         */
        mPaint.setStyle(Paint.Style.STROKE);
        mPaint.setStrokeWidth(mStrokeWidth);
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.color_lights));
        ...
        mPaint.setColor(ContextCompat.getColor(getContext(), R.color.color_dark_lights));
        int r = mRadius / 8;
