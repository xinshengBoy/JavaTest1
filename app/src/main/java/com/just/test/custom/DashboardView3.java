...
public class DashboardView3 extends View {
    ...
    private void init() {
        ...
        mBgColors = new int[]{ContextCompat.getColor(getContext(), R.color.color_reds),
                ContextCompat.getColor(getContext(), R.color.color_oranges),
                ContextCompat.getColor(getContext(), R.color.color_yellows),
                ContextCompat.getColor(getContext(), R.color.color_greens),
                ContextCompat.getColor(getContext(), R.color.color_blues)};
    }
