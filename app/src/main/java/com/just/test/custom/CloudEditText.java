...
public class CloudEditText extends EditText {
    ...
    private void init() {
        ...
        rightDrawable = getResources().getDrawable(R.drawable.icon_remove);
        drawablePadding = EditTextTools.dp2px(10);
        itemPadding = EditTextTools.dp2px(3);
...
//            int spansStringLength = getSpansStringLength(spans);
    ...
    private void generateOneSpan(Spannable spannableString, UnSpanText unSpanText) {
        ...
        BitmapDrawable bitmpaDrawable = (BitmapDrawable) EditTextTools.convertViewToDrawable(spanView);
...
//            System.out.println("start:"+start+";end:"+end);
    ...
    private BitmapDrawable drawImageSpan(int measuredWidth, String spanText) {
        ...
        textPaint.setTextSize(EditTextTools.dp2px((int) getTextSize()));
        textPaint.getTextBounds(spanText, 0, spanText.length(), textRect);
        int textPadding = EditTextTools.dp2px(6);
        ...
        Drawable background = getResources().getDrawable(R.drawable.bg_cloudedit);
    ...
    public View getSpanView(Context context, String text, int maxWidth) {
        ...
        view.setBackgroundResource(R.drawable.bg_cloudedit);
