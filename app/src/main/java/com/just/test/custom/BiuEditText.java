...
import com.just.test.activity.FlyingEditText;
...
public class BiuEditText extends EditText {
    ...
    private void init() {
        //FlyingEditText  一定要把当前使用的activity传进来
        contentContainer = (ViewGroup) ((FlyingEditText) getContext()).findViewById(android.R.id.content);
