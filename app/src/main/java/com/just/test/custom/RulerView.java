...
public class RulerView extends View {
    ...
    public RulerView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mTextSize = ta.getDimension(R.styleable.RulerView_textSizes, 18);
    ...
    public void setOnClickedListener(onClickLister listener){
        if (listener != null){
    ...
    private void onClickChanged(int scale){
        if (mClickListener != null){
            mClickListener.onClickChanged(scale);
        }
    }
    ...
    protected void onOverScrolled(int scrollX, int scrollY, boolean clampedX, boolean clampedY) {
        ...
        if (mClickListener != null){
            int position = computeSelectedPosition();
            onClickChanged(position + mBeginRange);
        }
    }
