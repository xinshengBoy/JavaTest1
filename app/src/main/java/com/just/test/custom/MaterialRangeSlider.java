...
public class MaterialRangeSlider extends View {
    ...
    private static final int DEFAULT_TOUCH_TARGET_SIZE = Math.round(EditTextTools.dp2px(40));
    ...
    public void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            min = styledAttrs.getInt(R.styleable.MaterialRangeSlider_RangeLineMin, min);
            max = styledAttrs.getInt(R.styleable.MaterialRangeSlider_RangeLineMax, max);
    ...
    private void getDefaultColors() {
        ...
        colorControlNormal = materialStyledAttrs.getColor(0, appcompatMaterialStyledAttrs.getColor(0, 0x1E90FF));
        colorControlHighlight = materialStyledAttrs.getColor(1, appcompatMaterialStyledAttrs.getColor(1, 0xff000000));
    ...
    private void getDefaultMeasurements() {
        pressedRadius = Math.round(EditTextTools.dp2px(DEFAULT_PRESSED_RADIUS));
        unpressedRadius = Math.round(EditTextTools.dp2px(DEFAULT_UNPRESSED_RADIUS));
        insideRangeLineStrokeWidth = Math.round(EditTextTools.dp2px(DEFAULT_INSIDE_RANGE_STROKE_WIDTH));
        outsideRangeLineStrokeWidth = Math.round(EditTextTools.dp2px(DEFAULT_OUTSIDE_RANGE_STROKE_WIDTH));
    }
